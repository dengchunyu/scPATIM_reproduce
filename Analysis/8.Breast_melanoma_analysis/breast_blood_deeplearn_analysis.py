...
os.chdir('/share/pub/dengcy/Cancer_Gwas/Runtime1.0/6.1.Immunotherapy/TNBC_data/GSE169246/blood_result')
adata = sc.read_h5ad("/share/pub/dengcy/Cancer_Gwas/Runtime1.0/6.1.Immunotherapy/TNBC_data/GSE169246/GSE169246_blood_T_pre.adata")

sc.pl.umap(adata, color='first_celltype_annotation', legend_loc="on data", title="TNBC ICI pre-treatment in blood",palette=color_annotation,size=5,add_outline=True, save='GSE169246_TNBC_blood_umap')

adata_melanoma = sc.read_h5ad('/share/pub/dengcy/Cancer_Gwas/Runtime1.0/6.1.Immunotherapy/melanoma_data/GSE166181/GSE166181_blood_pre_HCCs.adata')

sc.pl.umap(adata, color='first_celltype_annotation', legend_loc="on data", title="TNBC HCCs of ICI pre-treatment in blood",palette=color_annotation,size=5,add_outline=True, save='GSE169246_TNBC_HCCs_')
...
import matplotlib.pyplot as plt
#运行训练模型
train_loader, test_loader, feature_importance = MLP_model_test(adata,data_index="GSE169246_blood_BreastCancerHCGs")

train_loader2, test_loader2, feature_importance2 = MLP_model_test(adata_melanoma,data_index="GSE166181_blood_BreastCancerHCGs")
...
get_gene_performance(train_loader, test_loader,feature_importance,data_index="GSE169246_blood_BreastCancerHCGs")

get_gene_performance(train_loader2, test_loader2,feature_importance2,data_index="GSE166181_blood_BreastCancerHCGs")
